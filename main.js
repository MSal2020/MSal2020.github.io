(()=>{
    ...
    class e {
        ...
        toggleMenu() {
            ...
            this.menuOpen ? (this.button.classList.add("open"),
            ...
            this.footer.setAttribute("aria-hidden", !0)) : (this.button.classList.remove("open"),
        ...
        focusHandler(t) {
            9 === t.keyCode && (t.shiftKey && document.activeElement === this.firstFocusable ? (t.preventDefault(),
            this.lastFocusable.focus()) : t.shiftKey || document.activeElement !== this.lastFocusable || (t.preventDefault(),
    ...
    class s {
        ...
        disable() {
            ...
            this.animations.forEach((t=>{
                t.renderer && t.renderer.gl.clear(t.renderer.gl.COLOR_BUFFER_BIT | t.renderer.gl.DEPTH_BUFFER_BIT),
                t.ctx && t.ctx.clearRect(0, 0, t.canvas.width, t.canvas.height)
            }
            ))
        }
        onPreloaded() {
    ...
    c.Renderer = class {
        ...
        resize() {
            ...
            return !(this.gl.canvas.width * this.pixelRatio === t && this.gl.canvas.height * this.pixelRatio === e) && (this.gl.canvas.width = t,
            this.gl.canvas.height = e,
        ...
        render(t, e) {
            ...
            for (const o of t.objects) {
                ...
                let t = !1;
                if (o.shader.program !== s && (this.gl.useProgram(o.shader.program),
                s = o.shader.program,
                t = !0),
                t || o.attributes != i) {
                    for (const t in o.attributes) {
                        this.gl.enableVertexAttribArray(o.attributes[t].location),
                        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, o.attributes[t].buffer);
                ...
                for (const t in o.uniforms)
                    if ("uViewProjectionMatrix" === t)
                        this.gl.uniformMatrix4fv(o.uniforms[t].location, !1, o.projectionMatrix);
                    else if ("uNormalMatrix" === t)
                        this.gl.uniformMatrix4fv(o.uniforms[t].location, !1, o.normalMatrix);
                    else if ("uLocalMatrix" === t)
                        this.gl.uniformMatrix4fv(o.uniforms[t].location, !1, o.localMatrix);
                    else
                        ...
                        case "mat4":
                            ...
                            break;
                        case "tex":
                            this.gl.uniform1i(o.uniforms[t].location, o.uniforms[t].value.id),
                            this.gl.activeTexture(this.gl.TEXTURE0 + o.uniforms[t].value.id),
                            this.gl.bindTexture(this.gl.TEXTURE_2D, o.uniforms[t].value.texture)
                        }
    ...
    c.Orthographic = class {
        ...
        setViewProjectionMatrix() {
            ...
            this.viewProjectionMatrix = o.multiply(this.matrix, this.viewMatrix)
        }
        setLeft(t) {
            this.left = t,
            this.createMatrix()
    ...
    c.Perspective = class {
        ...
        createMatrix() {
            ...
            this.matrix = [2 * this.near / (this.right - this.left), 0, 0, 0, 0, 2 * this.near / (this.top - this.bottom), 0, 0, 0, 0, -(this.far + this.near) / (this.far - this.near), -1, -this.near * (this.right + this.left) / (this.right - this.left), -this.near * (this.top + this.bottom) / (this.top - this.bottom), 2 * this.far * this.near / (this.near - this.far), 0]
        }
        _recalculateViewMatrix() {
            const t = o.identity()
              , e = o.translate(this.position.x, this.position.y, this.position.z)
    ...
    c.Mesh = class {
        ...
        _setSurfaceNormals() {
            if (this.surfaceNormals) {
                ...
                this.shader.gl.bufferData(this.shader.gl.ARRAY_BUFFER, new Float32Array(t), this.shader.gl.STATIC_DRAW)
            }
        }
        _recalculateModelMatrix() {
            const t = o.identity()
            ...
            a = o.multiply(a, n),
            a = o.multiply(a, r),
            this.parentCollection ? this.localMatrix = o.multiply(this.parentCollection.localMatrix, a) : this.localMatrix = a
        }
    ...
    c.Plane = class extends r {
        constructor(t, e, s, i) {
            ...
            this.attributes.aNormal.data = new Float32Array(a),
            this.attributes.aNormal.count = a.length / 3;
            const c = [];
    ...
    c.Circle = class extends r {
        constructor(t, e) {
            ...
            s.push(Math.cos(0) * t, Math.sin(0) * t, 0),
            super(s);
            const i = [];
    ...
    c.Tetrahedron = class extends r {
        constructor(t) {
            const e = [];
            Math.sqrt(3);
            e.push(-t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6, t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6, 0, t * Math.sqrt(3) / 3, 0, t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6, 0, -t * Math.sqrt(3) / 6, -t * Math.sqrt(3) / 3, 0, t * Math.sqrt(3) / 3, 0, 0, -t * Math.sqrt(3) / 6, -t * Math.sqrt(3) / 3, -t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6, 0, t * Math.sqrt(3) / 3, 0, -t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6, 0, -t * Math.sqrt(3) / 6, -t * Math.sqrt(3) / 3, t / 2, -t * Math.sqrt(3) / 6, t * Math.sqrt(3) / 6),
            super(e);
            const s = [];
            for (let t = 0; t < e.length; t += 9)
                27 === t ? s.push(1, (1 - Math.sqrt(.75)) / 2, .5, (1 - Math.sqrt(.75)) / 2 + Math.sqrt(.75), 0, (1 - Math.sqrt(.75)) / 2) : s.push(0, (1 - Math.sqrt(.75)) / 2, 1, (1 - Math.sqrt(.75)) / 2, .5, (1 - Math.sqrt(.75)) / 2 + Math.sqrt(.75));
            ...
            function h(t, e, s, i, o, n, h, c, l, u, d) {
                ...
                for (let n = 0; n < c; n++)
                    for (let c = 0; c < h; c++) {
                        ...
                        for (let s = 0; s < 6; s++) {
                            let n, r;
                            n = u ? 1 - (h[t][s] + i / 2) / i : (h[t][s] + i / 2) / i,
                            r = d ? 1 - (h[e][s] + o / 2) / o : (h[e][s] + o / 2) / o,
                            a.push(n, r)
                        }
                    }
            }
    ...
    c.Sphere = class extends r {
        constructor(t, e) {
            ...
            for (let t = 0; t < this.attributes.aNormal.data.length; t += 3) {
                ...
                const s = .5 + Math.atan2(this.attributes.aNormal.data[t], this.attributes.aNormal.data[t + 2]) / (2 * Math.PI)
                  , o = .5 - Math.asin(this.attributes.aNormal.data[t + 1]) / Math.PI;
                i.push(s + e, 1 - o)
            }
            const n = 12 * e
              , r = n / 4 * 3;
    ...
    c.Cylinder = class extends r {
        constructor(t, e, s) {
            ...
            this.attributes.aNormal.data = new Float32Array(o),
            this.attributes.aNormal.count = o.length / 3;
            const r = [];
    ...
    c.Program = class {
        constructor(t, e, s) {
            ...
            this.gl = t,
            this.id = a++,
            this.program = this._createProgram(t, i, o)
        }
        _createShader(t, e, s) {
        ...
        _createProgram(t, e, s) {
            ...
            if (t.getProgramParameter(i, t.LINK_STATUS))
                return i;
            console.log(t.getProgramInfoLog(i)),
            t.deleteProgram(i)
        }
    }
    ,
    ...
    c.DataTexture = class {
        constructor(t, e, s, i, o, n) {
            ...
            this.width = s,
            this.height = i,
            this.data = o ? new Uint8Array(o) : null,
            e) {
            case "rgba":
            default:
    ...
    c.Light = class {
        constructor(t, e) {
            this.type = t,
            "directional" === this.type ? this.direction = i.normalize([e[0], e[1], e[2]]) : "point" === this.type && (this.position = [e[0], e[1], e[2]])
        }
        setDirection(t, e, s) {
    ...
    c.ColorPicker = class {
        ...
        getMatrix() {
            ...
            "perspective" === this.camera.type ? (this.top = this.camera.near * Math.tan(this.camera.fieldOfView / 2),
            this.bottom = -this.top,
            this.right = this.top * this.camera.aspectRatio,
            this.left = -this.right) : "orthographic" === this.camera.type && (this.top = this.camera.top,
    ...
    class d {
        ...
        update(t) {
            "class" !== this.property ? this.target[this.property] = this.propertyDelta.start + t * this.propertyDelta.delta + this.units : (0 === t && ("addClass" === this.direction ? this.target.classList.remove(this.targetValue) : this.target.classList.add(this.targetValue)),
            1 === t && this.classFunction())
        }
    }
    class p {
        constructor(t, e, s, i) {
        ...
        _getTransformMatrix(t) {
            ...
            return "2d" === this.transformType ? {
                ...
                scaleX: e[0],
                scaleY: e[3],
                rotate: Math.atan2(e[1], e[0]) * (180 / Math.PI)
            } : void 0
        }
            ...
            this.isDOM) {
                ...
                for (const e in this.properties)
                    if (this.transformPropertyKeys.includes(e))
                        if (this.hasTransform = !0,
                        "scale" === e)
                            "fromTo" === this.direction ? (this.actions.push(new d(this.transformMatrix,"scaleX",this.properties.scale[1],this.properties.scale[0],null,this.direction)),
                            this.actions.push(new d(this.transformMatrix,"scaleY",this.properties.scale[1],this.properties.scale[0],null,this.direction))) : (this.actions.push(new d(this.transformMatrix,"scaleX",this.properties.scale,parseFloat(this.transformMatrix.scaleX),null,this.direction)),
                            ...
                            "fromTo" === this.direction ? this.actions.push(new d(this.transformMatrix,e,this.properties[e][1],this.properties[e][0],null,this.direction)) : this.actions.push(new d(this.transformMatrix,e,this.properties[e],parseFloat(this.transformMatrix[e]),null,this.direction));
                        ...
                        if ("fromTo" === this.direction)
                            this.actions.push(new d(this.target.style,e,this.properties[e][1],this.properties[e][0],null,this.direction));
                        else {
                        ...
                        this.actions.push(new d(this.target,e,this.properties[e],null,null,this.direction))
            } else
                for (const t in this.properties)
                    "fromTo" === this.direction ? this.actions.push(new d(this.target,t,this.properties[t][1],this.properties[t][0],null,this.direction)) : this.actions.push(new d(this.target,t,this.properties[t],this.target[t],null,this.direction));
    ...
    class m {
        static to(t, e, s) {
            let i = !1
              , o = t;
            (t instanceof window.HTMLElement || t instanceof window.NodeList) && (i = !0,
            t instanceof window.NodeList && (o = [...t]));
        ...
        static _animate(t, e, s) {
            ...
            requestAnimationFrame((function o(n) {
                ...
                a < 1 ? (s.onUpdate && s.onUpdate(),
                requestAnimationFrame(o)) : (t.forEach((t=>{
                    t.update(1)
                }
                )),
        ...
        static _setTimings(t, e) {
            const s = 1e3
              , i = {};
            return i.duration = e.duration ? e.duration * s : 1,
            i.delay = e.delay ? e.delay * s : 0,
            i.stagger = e.stagger ? e.stagger * s : 0,
            i.totalDuration = i.duration + (t.length - 1) * i.stagger,
            i.easing = l.get(e.ease),
            i
        }
    }
    m.Scene = class {
        ...
        play() {
            this.rewinding = !1,
            this.started || (this.onStartCallback && this.onStartCallback(),
            this.started = !0),
            ...
            const t = e=>{
                ...
                this.progress = Math.min(s / this.duration, 1),
                this._animate(),
                this.progress < 1 && (this.currentAnimationFrame = requestAnimationFrame(t))
            }
            ;
        ...
        rewind() {
            this.rewinding = !0,
            this.paused ? this.startTime = performance.now() - this.duration * (1 - this.progress) : this.startTime = performance.now(),
            this.paused = !1;
            const t = e=>{
                const s = this.duration - (e - this.startTime);
                this.progress = Math.min(s / this.duration, 1),
                this._animate(),
                this.progress > 0 && (this.currentAnimationFrame = requestAnimationFrame(t))
            }
            ;
            this.currentAnimationFrame = requestAnimationFrame(t)
        }
        setProgress(t) {
            this.progress = t,
            !this.started && this.progress > 0 && (this.onStartCallback && this.onStartCallback(),
            this.started = !0);
            this.currentAnimationFrame = requestAnimationFrame((t=>{
                this.duration,
                this.progress;
        ...
        _animate() {
            ...
            this.actions.forEach(((t,e)=>{
                ...
                t.started && !t.completed && (t.options.onUpdate && t.options.onUpdate(),
                t.moments.forEach(((e,s)=>{
                    ...
                    e.update(n),
                    t.options.toggle && 1 !== o && e.update(0)
                }
                ))),
                t.progress > 0 ? (t.started || (t.options.onStart && t.options.onStart(),
                0 !== t.timings.start && "from" !== t.direction && t.moments.forEach((t=>{
                    t.setProperties()
                }
                ))),
                ...
                t.started = !1),
                t.progress >= 1 ? (t.completed || (t.moments.forEach((t=>{
                    t.update(1)
                }
                )),
                t.options.onComplete && t.options.onComplete()),
                t.completed = !0) : t.completed = !1
            }
            ))
        }
        to(t, e, s, i=null) {
            let o = !1
              , n = t;
            (t instanceof window.HTMLElement || t instanceof window.NodeList || t instanceof window.SVGPathElement || t instanceof window.SVGElement || t instanceof window.SVGCircleElement) && (o = !0,
            t instanceof window.NodeList && (n = [...t]));
        ...
        addClass(t, e, s, i=null) {
            let o = !1
              , n = t;
            (t instanceof window.HTMLElement || t instanceof window.NodeList) && (o = !0,
            t instanceof window.NodeList && (n = [...t]));
            const r = this._setTargets(n)
              , a = this._setTimings(r, s, i)
              , h = [];
        ...
        _setTimings(t, e, s) {
            ...
            let n = 0;
            n = null !== s ? s * this.timeScale : this.duration,
            i.stagger = e.stagger ? e.stagger * this.timeScale : 0;
    ...
    m.Camera = class {
        ...
        _init() {
            ...
            this.options.pinned ? (this.offset = this.element.parentElement.offsetTop,
            ...
            this.scrollHeight += this.options.offset ? this.options.offset : 0) : (this.offset = window.pageYOffset + this.element.getBoundingClientRect().top - this.viewportHeight,
        ...
        _createObserver() {
            this.observer = new IntersectionObserver((t=>{
                t.forEach((t=>{
                    t.isIntersecting ? (this.isIntersecting = !0,
                    window.addEventListener("scroll", this._scrollListener)) : (this.isIntersecting = !1,
        ...
        splitTitle() {
            ...
            for (let s = 0; s < e.length; s++) {
                ...
                if (i.nodeType === Node.TEXT_NODE) {
                    ...
                    for (let s = 0; s < e.length; s++)
                        if ("" !== e[0] || 0 !== s) {
                            if (i = document.createElement("span"),
                            ...
                            "" === e[0]) {
                                ...
                                let t = document.createTextNode(e[s]);
                                s !== e.length - 1 && (t = document.createTextNode(e[s] + " ")),
                                i.appendChild(t)
                            }
                            t.appendChild(i)
                        }
    ...
    class f {
        ...
        draw() {
            ...
            for (let s = 0; s < this.iterations; s++) {
                e = .5 * Math.sin(-this.time + Math.PI / 2 + s / 2) + .5,
    ...
    class x {
        ...
        createGridGeometry(t, e) {
            ...
            return h.setAttribute("aUV", new Float32Array(l), 2),
            h
        }
        reset() {
            this.progress = {
            ...
            this.scene.fromTo(this.progress, {
            ...
            this.viewport.height <= this.viewport.width ? (this.scene.fromTo(this.progress, {
                centerX: [.5, .75],
                centerY: [.5, .75],
            ...
            this.scene.fromTo(this.progress, {
                ...
                centerX: [.5, .5 + this.viewport.width / this.viewport.height * .25],
                centerY: [.5, .75],
            ...
            this.scene.to(this.progress, {
                centerX: .5 - this.viewport.width / this.viewport.height * .25,
                centerY: .5,
        ...
        onResize(t) {
            this.viewport = t,
            this.camera.setFieldOfView(2 * Math.atan(t.height / 2 / 500) * (180 / Math.PI)),
            ...
            this.gridMesh.setUniform("uCenterPoint", [.5, .5], "2f"),
            ...
            this.loupeMesh.setUniform("uBaseThickness", .05 / this.viewport.width * this.viewport.width, "1f"),
    ...
    class w {
        ...
        onResize(t) {
            ...
            this.scene = this.pixelPerfect.scene,
            this.scene.fromTo(this.textElement, {
                translateY: [100, -100]
            }, {
                duration: 2,
                ease: "linear"
            ...
            this.scene.to(this.textElement, {
                opacity: 0
            }, {
                duration: 1,
                ease: "easeInOutExpo"
    ...
    class M extends s {
        constructor() {
            ...
            y)
                return y;
            y = this,
            this.setDOM("section.pixel-perfect"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new x),
            this.addAnimation(new w),
            this.enable()
        }
        initializeTextFocus() {
        ...
        onScroll(t) {
            ...
            this.isActive) {
                ...
                t.y <= this.metrics.scrollY + this.enterThreshold ? this.progress = 0 : this.progress = 1,
        ...
        onResize(t) {
            ...
            this.attachScene(),
            super.onResize(t),
            this.enterThreshold = this.exitThreshold = -t.height,
            this.initializeTextFocus()
        }
        onUpdate(t) {
            this.isActive && (this.scene.setProgressImmediately(this.progress),
            this.animations.forEach((e=>{
                e.onUpdate && e.onUpdate(t)
            }
            )))
    ...
    class T {
        ...
        draw() {
            ...
            this.ctx.fill(),
            this.clearProgress.value > 0 && (this.ctx.clearRect(this.canvas.width / 2 - this.clearProgress.value * (this.canvas.width / 2), this.canvas.height / 2 - this.clearProgress.value * (this.canvas.height / 2), this.clearProgress.value * this.canvas.width, this.clearProgress.value * this.canvas.height),
            1 !== this.clearProgress.value && (this.ctx.beginPath(),
            this.ctx.rect(this.canvas.width / 2 - this.clearProgress.value * (this.canvas.width / 2), this.canvas.height / 2 - this.clearProgress.value * (this.canvas.height / 2), this.clearProgress.value * this.canvas.width, this.clearProgress.value * this.canvas.height),
            this.ctx.closePath(),
        ...
        onResize(t) {
            ...
            this.scene.fromTo(this.iterations, {
                count: [0, 20]
            }, {
                duration: 1,
                ease: "linear"
            ...
            this.scene.fromTo(this.clearProgress, {
                value: [0, 1]
            }, {
                duration: 1
            }, 1),
    ...
    class P {
        ...
        onResize(t) {
            ...
            this.textAnimation.fromTo(this.overlayProgress, {
                translateX: [-101, 101]
            }, {
                duration: 1,
                stagger: .2,
            ...
            this.textAnimation.to(this.textElements, {
                opacity: 1
            }, {
                delay: .5,
                duration: .5,
            ...
            this.textAnimation.to(this.textFlourishShort, {
                "stroke-dashoffset": 31
            }, {
                duration: .5,
                ease: "easeInOutQuint"
            }, 1.5),
            this.textAnimation.to(this.textFlourishLong, {
                "stroke-dashoffset": 42
            }, {
                duration: .5,
                ease: "easeInOutQuint"
            }, 1.5),
            this.scene.fromTo(this.textWrapper, {
                opacity: [0, 1]
            }, {
                duration: .1,
                ease: "easeInOutExpo",
                onComplete: ()=>{
                    this.played || (this.textAnimation.play(),
                    this.played = !0)
                }
            }, 0),
            this.scene.fromTo(this.textWrapper, {
    ...
    class b extends s {
        constructor() {
            ...
            E)
                return E;
            E = this,
            this.setDOM("section.animation"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new T),
            this.addAnimation(new P)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
    ...
    class S {
        ...
        draw() {
            ...
            for (let t = 0; t < this.balloons.length; t++)
                ...
                this.balloons[t].y < -130 * this.scaleFactor ? (this.balloons[t].x = Math.random() * (this.viewport.width - 75 * this.scaleFactor),
                this.balloons[t].y = this.viewport.height) : this.drawBalloon(this.balloons[t]);
            this.drawReticle(this.mouse.xOffset, this.mouse.yOffset)
        }
        drawBalloon(t) {
            this.ctx.scale(t.scale, t.scale),
            this.ctx.translate(t.x / t.scale - 5 * t.scale, t.y / t.scale - 5 * t.scale);
            ...
            this.ctx.isPointInPath(e, this.mouse.xOffset, this.mouse.yOffset) && !t.isPopped ? (this.ctx.strokeStyle = `rgba(104, 189, 231, ${t.opacity})`,
            this.ctx.fillStyle = `rgba(0, 0, 0, ${t.opacity})`,
            this.clicking && (m.fromTo(this.progress, {
                impact: [1, 0]
            }, {
                duration: .125,
                ease: "linear"
            ...
            m.to(t, {
                ...
                ease: "easeOutExpo",
                onComplete: ()=>{
                    t.x = Math.random() * (this.viewport.width - 75 * this.scaleFactor),
            ...
            t.isPopped = !0)) : (this.ctx.strokeStyle = `rgba(214, 103, 97, ${t.opacity})`,
            this.ctx.fillStyle = `rgba(0, 0, 0, ${t.opacity})`),
            this.ctx.fill(e),
            this.ctx.stroke(e),
            this.ctx.stroke(s),
        ...
        createBalloon(t, e) {
            let s = 0
              , i = 0;
            s = t || Math.random() * (this.viewport.width - 75 * this.scaleFactor),
            i = e || Math.random() * this.viewport.height;
        ...
        drawReticle(t, e) {
            this.reticleLines(t, e),
            this.reticleCircle(t, e),
            this.reticleChevrons(t, e),
            this.reticleTargetPoint(t, e),
            this.reticleImpact(t, e)
        }
        reticleLines(t, e) {
        ...
        reticleTargetPoint(t, e) {
            this.ctx.fillStyle = `rgba(255, 255, 255, ${this.progress.triggerFlash}`,
            this.ctx.beginPath(),
            this.ctx.arc(t, e, 4, 0, 2 * Math.PI, !0),
            this.ctx.closePath(),
            this.ctx.fill()
        }
        reticleImpact(t, e) {
            ...
            const s = -Math.PI / 8;
            this.progress.impact > 0 && (this.ctx.beginPath(),
        ...
        onMouseDown(t) {
            ...
            e ? (this.mouse.x = e[0].clientX,
            this.mouse.y = e[0].clientY) : (this.mouse.x = t.clientX,
    ...
    class _ extends s {
        constructor() {
            ...
            I = this,
            this.persistentAnimation = !0,
            this.setDOM("section.interactive"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new S),
            this.addAnimation(new R)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
    ...
    class z {
        ...
        onScroll(t) {
            ...
            t.y >= e + this.metrics.motorOffset && (this.motorPathHasRun || (this.motorScene.play(),
            this.motorPathHasRun = !0)),
            t.y >= e + this.metrics.visionOffset && (this.visionPathHasRun || (this.visionScene.play(),
            this.visionPathHasRun = !0)),
            t.y >= e + this.metrics.hearingOffset && (this.hearingPathHasRun || (this.hearingScene.play(),
            this.hearingPathHasRun = !0))
        }
        onDestroy() {
        ...
        onResize(t) {
            ...
            this.motorScene.fromTo(this.motorIcon, {
                scale: [.8, 1],
                opacity: [0, 1]
            }, {
                duration: 2.5,
            ...
            this.motorScene.fromTo(this.motorPath, {
                "stroke-dashoffset": [954, 0]
            }, {
                duration: 2.5,
                ease: "easeInOutQuint"
            }, 0),
            this.motorScene.fromTo(this.motorWaves, {
                opacity: [0, .5]
            }, {
                duration: .5,
                ease: "easeInOutSine",
            ...
            this.visionScene.fromTo(this.visionIcon, {
                scale: [.8, 1],
                opacity: [0, 1]
            }, {
                duration: 2.5,
            ...
            this.visionScene.fromTo(this.visionOuterPath, {
                "stroke-dashoffset": [555, 0]
            }, {
                duration: 2.5,
                ease: "easeInOutQuint"
            }, 0),
            this.visionScene.fromTo(this.visionInnerPath, {
                "stroke-dashoffset": [230, 0]
            }, {
                duration: 2,
                ease: "easeInOutQuint"
            }, .5),
            this.visionScene.fromTo(this.visionWaves, {
                opacity: [0, .5]
            }, {
                duration: .5,
                ease: "easeInOutSine",
            ...
            this.hearingScene.fromTo(this.hearingIcon, {
                scale: [.8, 1],
                opacity: [0, 1]
            }, {
                duration: 2.5,
            ...
            this.hearingScene.fromTo(this.hearingOuterPath, {
                "stroke-dashoffset": [468, 936]
            }, {
                duration: 2,
                ease: "easeInOutQuint"
            }, 0),
            this.hearingScene.fromTo(this.hearingInnerPath, {
                "stroke-dashoffset": [138, 276]
            }, {
                duration: 2.5,
                ease: "easeInOutQuint"
            }, 0),
            this.hearingScene.fromTo(this.hearingSquigglePath, {
                "stroke-dashoffset": [55, 110]
            }, {
                duration: 1.25,
                ease: "easeOutQuint"
            }, 1.25),
            this.hearingScene.fromTo(this.hearingWaves, {
                opacity: [0, .5]
            }, {
                duration: .5,
                ease: "easeInOutSine",
    ...
    class O extends s {
        constructor() {
            ...
            A)
                return A;
            A = this,
            this.setDOM("section.accessible"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new z)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
    ...
    class L {
        ...
        createCube(t) {
            ...
            E.setPosition(-.1, -.1, 0),
            E.setParent(e),
            this.tesseracts.push(E);
            const b = new c.Mesh(i,this.tesseractShader);
            return b.setPosition(.1, -.1, 0),
            b.setParent(e),
            this.tesseracts.push(b),
            e
        }
        createLineInstance(t, e, s, i, o, n) {
            ...
            r.setRotationY(o),
            r.startPosition = e,
            r.endPositionDelta = s,
            this.tesseractLines.push(r)
        }
        ...
        createTesseracts() {
            ...
            this.viewport.aspectRatio > 1 ? (this.createTesseractInstance({
                x: -.625 * this.viewport.aspectRatio,
                y: .625,
                z: 0
            }),
            ...
            this.createTesseractInstance({
                ...
                x: -.4375 * this.viewport.aspectRatio,
                y: .625,
                z: 0
            }),
            this.createTesseractInstance({
            ...
            this.tesseracts.forEach((t=>{
                t.setUniform("uGreenToRed", 0, "1f"),
                t.setUniform("uRedToBlue", 0, "1f"),
                this.volume.add(t)
            }
            )),
        ...
        onResize(t) {
            this.viewport = t,
            this.camera.setLeft(-t.aspectRatio),
            this.camera.setRight(t.aspectRatio),
            this.volume.objects = [],
            this.createTesseracts(),
            this.renderer.resize(),
            this.reset()
        ...
        onUpdate(t) {
            ...
            for (let t = 0; t < this.tesseractLines.length; t++)
                this.progress.reveal2D >= 1 && this.progress.reveal3D < 1 ? (this.tesseractLines[t].uniforms.uGreenToRed.value = 1,
                this.tesseractLines[t].uniforms.uRedToBlue.value = 0) : this.progress.reveal3D >= 1 && this.progress.reveal4D < 1 ? (this.tesseractLines[t].uniforms.uGreenToRed.value = 1,
                this.tesseractLines[t].uniforms.uRedToBlue.value = 1) : (this.tesseractLines[t].uniforms.uGreenToRed.value = 0,
                this.tesseractLines[t].uniforms.uRedToBlue.value = 0),
                this.tesseractLines[t].setPosition(this.tesseractLines[t].startPosition.x + this.progress.reveal4D * this.tesseractLines[t].endPositionDelta.x, this.tesseractLines[t].startPosition.y + this.progress.reveal4D * this.tesseractLines[t].endPositionDelta.y, this.tesseractLines[t].startPosition.z + this.progress.reveal4D * this.tesseractLines[t].endPositionDelta.z),
            ...
            for (let t = 0; t < this.tesseracts.length; t++)
                this.progress.reveal2D >= 1 && this.progress.reveal3D < 1 ? (this.tesseracts[t].uniforms.uGreenToRed.value = 1,
                this.tesseracts[t].uniforms.uRedToBlue.value = 0) : this.progress.reveal3D >= 1 && this.progress.reveal4D < 1 ? (this.tesseracts[t].uniforms.uGreenToRed.value = 1,
                this.tesseracts[t].uniforms.uRedToBlue.value = 1) : (this.tesseracts[t].uniforms.uGreenToRed.value = 0,
                this.tesseracts[t].uniforms.uRedToBlue.value = 0);
            this.renderer.gl.clearColor(0, 0, 0, 0),
            this.renderer.render(this.volume, this.camera)
        }
    }
    class C {
        ...
        onResize(t) {
            ...
            this.scene.fromTo(this.two, {
                scale: [1, 1.25]
            }, {
                duration: 1.25,
                ease: "easeOutExpo"
            }, 0),
            this.scene.fromTo(this.three, {
                scale: [1, 1.25]
            }, {
                duration: .5,
                ease: "easeOutExpo"
            }, 1.25),
            this.scene.fromTo(this.four, {
                scale: [1, 1.25]
            }, {
                duration: 1.25,
                ease: "easeOutExpo"
        ...
        onUpdate(t) {
            this.progress.value >= 0 && this.progress.value < 1.25 ? (this.two.classList.remove("hidden"),
            this.three.classList.add("hidden"),
            this.four.classList.add("hidden")) : this.progress.value >= 1.25 && this.progress.value < 1.75 ? (this.two.classList.add("hidden"),
            this.three.classList.remove("hidden"),
            this.four.classList.add("hidden")) : (this.two.classList.add("hidden"),
            this.three.classList.add("hidden"),
            this.four.classList.remove("hidden"));
            let e = "";
            for (let t = 0; t < this.progress.questionMarks; t++)
                e += "?";
    ...
    class U extends s {
        constructor() {
            ...
            F)
                return F;
            F = this,
            this.setDOM("section.dimensions"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new D),
            this.addAnimation(new L),
            this.addAnimation(new C)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
    ...
    class N {
        ...
        onResize(t) {
            ...
            this.scene.fromTo(this.background, {
                opacity: [0, 1]
            }, {
                duration: 1
            }, 0),
    ...
    class k {
        constructor() {
            this.photography = new B,
            this.collage = document.querySelector("section.photography .photography--collage")
        }
        onResize(t) {
            this.viewport = t,
            this.scene = this.photography.scene,
            this.scene.addClass(this.collage, {
                class: "enter"
            }, {
                toggle: !0
            }, .75)
    ...
    class B extends s {
        constructor() {
            ...
            H)
                return H;
            H = this,
            this.setDOM("section.photography"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new N),
            this.addAnimation(new k),
            this.addAnimation(new Y)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
    ...
    class q {
        ...
        draw() {
            this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height),
            this.imageReady && (this.ctx.globalCompositeOperation = "destination-atop",
            ...
            this.ctx.fillText("adventures", this.progress.xPosition - this.text.width / 2 - (this.text.width / 2 - this.lastChar.width / 2) * this.progress.xOffset, this.progress.yPosition + this.lastChar.actualBoundingBoxAscent / 2 * this.progress.xOffset)
        }
        setImageDimensions() {
            this.viewport.aspectRatio < this.imageDimensions.aspectRatio ? (this.imageDimensions.scaledHeight = this.imageDimensions.height,
            ...
            this.imageDimensions.yOffset = 0) : (this.imageDimensions.scaledHeight = this.imageDimensions.width / this.viewport.aspectRatio,
        ...
        onResize(t) {
            ...
            this.scene.fromTo(this.introText, {
                translateX: [-50, -50],
                translateY: [-50, -400],
                opacity: [1, 0]
            }, {
        ...
        onUpdate(t) {
            ...
            this.time += this.now - this.then,
            this.then = this.now,
            this.initialRender ? this.draw() : (this.initialRender = !0,
            this.scene.setProgressImmediately(.25))
        }
    }
    class V {
        constructor() {
            this.travel = new X,
            this.overlay = document.querySelector("section.travel .travel--overlay")
        }
        onResize(t) {
            this.scene = this.travel.scene,
            this.scene.fromTo(this.overlay, {
                opacity: [0, 1]
            }, {
                duration: 1
            }, 2)
    ...
    class X extends s {
        constructor() {
            ...
            G)
                return G;
            G = this,
            this.setDOM("section.travel"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new q),
            this.addAnimation(new V)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
            this.DOM.querySelectorAll("[data-focus]").forEach((e=>{
        ...
        onResize(t) {
            ...
            this.attachScene(),
            super.onResize(t),
            this.enterThreshold = -t.height / 4,
            this.exitThreshold = -t.height,
            this.initializeTextFocus()
        }
        onUpdate(t) {
    ...
    class j {
        ...
        onResize(t) {
            ...
            this.textAnimation = new m.Scene,
            this.textAnimation.fromTo(this.splitText, {
                opacity: [0, 1],
                translateY: [50, 0]
            }, {
                duration: 1,
            ...
            this.scene.fromTo(this.textWrapper, {
                ...
                ease: "easeInOutExpo",
                onComplete: ()=>{
                    this.played && "0" !== this.splitText[0].style.opacity || (this.textAnimation.play(),
                    this.played = !0)
                }
            }, 0)
        }
    ...
    class W {
        ...
        onMouseMove(t) {
            this.touchEvent || (this.bounds = this.cta.getBoundingClientRect(),
            this.mouse.x = t.clientX,
            this.mouse.y = t.clientY),
            this.touchEvent = !1
        }
        onUpdate(t) {
            this.calculateMouseOffset(),
            this.mouse.xOffsetCurrent = this.lerp(this.mouse.xOffsetCurrent, this.mouse.xOffsetTarget, .1),
            this.mouse.yOffsetCurrent = this.lerp(this.mouse.yOffsetCurrent, this.mouse.yOffsetTarget, .1),
    ...
    class $ extends s {
        constructor() {
            ...
            Q = this,
            this.persistentAnimation = !0,
            this.setDOM("section.contact"),
            this.attachScene(),
            this.progress = 0,
            this.addAnimation(new j),
            this.addAnimation(new W)
        }
        initializeTextFocus() {
            const t = this.viewport.height / 100;
    ...
    class Z {
        constructor() {
            ...
            this.DOM = document.querySelectorAll("section.work .work--grid .work--item"),
            this.cards = [];
            const t = window.matchMedia("(min-width: 768px)");
            t.addListener(this.mediaMatch.bind(this)),
            this.mediaMatch(t)
        }
        mediaMatch(t) {
        ...
        onResize(t) {
            this.viewport = t,
            this.shouldAnimate ? (this.createCardObjects(),
            this.createScenes()) : this.cards = []
        }
        onScroll(t) {
    ...
    class K {
        constructor() {
            ...
            const t = new c.Plane(2,2,1,1)
              , e = new c.Program(this.renderer.gl,"#ifdef GL_FRAGMENT_PRECISION_HIGH\n\tprecision highp float;\n#else\n\tprecision mediump float;\n#define GLSLIFY 1\n#endif\n\nattribute vec4 aPosition;\nattribute vec3 aNormal;\nattribute vec2 aUV;\n\nuniform mat4 uViewProjectionMatrix;\nuniform mat4 uNormalMatrix;\nuniform mat4 uLocalMatrix;\n\nvarying vec3 vNormal;\nvarying vec2 vUV;\n\nvoid main() {\n\tvec4 position = uViewProjectionMatrix * uLocalMatrix * aPosition;\n\tgl_Position = position;\n\tvNormal = aNormal;\n\tvUV = aUV;\n}","#ifdef GL_FRAGMENT_PRECISION_HIGH\n\tprecision highp float;\n#else\n\tprecision mediump float;\n#define GLSLIFY 1\n#endif\n\nuniform float uTime;\n\nvarying vec3 vNormal;\nvarying vec2 vUV;\n\nvec4 permute(vec4 x){return mod(((x*34.0)+1.0)*x, 289.0);}\nvec4 taylorInvSqrt(vec4 r){return 1.79284291400159 - 0.85373472095314 * r;}\n\nfloat snoise(vec3 v){ \n\tconst vec2  C = vec2(1.0/6.0, 1.0/3.0);\n\tconst vec4  D = vec4(0.0, 0.5, 1.0, 2.0);\n\n\tvec3 i  = floor(v + dot(v, C.yyy) );\n\tvec3 x0 =   v - i + dot(i, C.xxx) ;\n\n\tvec3 g = step(x0.yzx, x0.xyz);\n\tvec3 l = 1.0 - g;\n\tvec3 i1 = min( g.xyz, l.zxy );\n\tvec3 i2 = max( g.xyz, l.zxy );\n\n\tvec3 x1 = x0 - i1 + 1.0 * C.xxx;\n\tvec3 x2 = x0 - i2 + 2.0 * C.xxx;\n\tvec3 x3 = x0 - 1. + 3.0 * C.xxx;\n\n\ti = mod(i, 289.0 ); \n\tvec4 p = permute( permute( permute( \n\t\ti.z + vec4(0.0, i1.z, i2.z, 1.0 ))\n\t+ i.y + vec4(0.0, i1.y, i2.y, 1.0 )) \n\t+ i.x + vec4(0.0, i1.x, i2.x, 1.0 ));\n\n\tfloat n_ = 1.0/7.0;\n\tvec3  ns = n_ * D.wyz - D.xzx;\n\n\tvec4 j = p - 49.0 * floor(p * ns.z *ns.z);\n\n\tvec4 x_ = floor(j * ns.z);\n\tvec4 y_ = floor(j - 7.0 * x_ );\n\n\tvec4 x = x_ *ns.x + ns.yyyy;\n\tvec4 y = y_ *ns.x + ns.yyyy;\n\tvec4 h = 1.0 - abs(x) - abs(y);\n\n\tvec4 b0 = vec4( x.xy, y.xy );\n\tvec4 b1 = vec4( x.zw, y.zw );\n\n\tvec4 s0 = floor(b0)*2.0 + 1.0;\n\tvec4 s1 = floor(b1)*2.0 + 1.0;\n\tvec4 sh = -step(h, vec4(0.0));\n\n\tvec4 a0 = b0.xzyw + s0.xzyw*sh.xxyy;\n\tvec4 a1 = b1.xzyw + s1.xzyw*sh.zzww;\n\n\tvec3 p0 = vec3(a0.xy,h.x);\n\tvec3 p1 = vec3(a0.zw,h.y);\n\tvec3 p2 = vec3(a1.xy,h.z);\n\tvec3 p3 = vec3(a1.zw,h.w);\n\n\tvec4 norm = taylorInvSqrt(vec4(dot(p0,p0), dot(p1,p1), dot(p2, p2), dot(p3,p3)));\n\tp0 *= norm.x;\n\tp1 *= norm.y;\n\tp2 *= norm.z;\n\tp3 *= norm.w;\n\n\tvec4 m = max(0.6 - vec4(dot(x0,x0), dot(x1,x1), dot(x2,x2), dot(x3,x3)), 0.0);\n\tm = m * m;\n\treturn 42.0 * dot( m*m, vec4( dot(p0,x0), dot(p1,x1), \n\t\tdot(p2,x2), dot(p3,x3) ) );\n}\n\nvoid main() {\n\tfloat v = snoise(vec3(vUV*3., uTime/16.));\n  \tfloat expo = pow(v, 10.0)/4. + v/12.;\n\tgl_FragColor = vec4(expo, expo, expo, 1.0);\n}");
            this.morphMesh = new c.Mesh(t,e),
            this.morphMesh.setPosition(0, 0, 0),
            this.morphMesh.setUniform("uTime", 0, "1f"),
            this.volume.add(this.morphMesh);
            const s = new c.Plane(2,2,1,1)
              , i = new c.Program(this.renderer.gl,"#ifdef GL_FRAGMENT_PRECISION_HIGH\n\tprecision highp float;\n#else\n\tprecision mediump float;\n#define GLSLIFY 1\n#endif\n\nattribute vec4 aPosition;\nattribute vec3 aNormal;\nattribute vec2 aUV;\n\nuniform mat4 uViewProjectionMatrix;\nuniform mat4 uNormalMatrix;\nuniform mat4 uLocalMatrix;\n\nvarying vec3 vNormal;\nvarying vec2 vUV;\n\nvoid main() {\n\tvec4 position = uViewProjectionMatrix * uLocalMatrix * aPosition;\n\tgl_Position = position;\n\tvNormal = aNormal;\n\tvUV = aUV;\n}","#ifdef GL_FRAGMENT_PRECISION_HIGH\n\tprecision highp float;\n#else\n\tprecision mediump float;\n#define GLSLIFY 1\n#endif\n\nuniform float uTime;\n\nvarying vec3 vNormal;\nvarying vec2 vUV;\n\nfloat hash(vec2 p) { return fract(1e4 * sin(17.0 * p.x + p.y * 0.1) * (0.1 + abs(sin(p.y * 13.0 + p.x)))); }\n\nvoid main() {\n\tfloat color = hash(vUV + uTime);\n\tgl_FragColor = vec4(vec3(color) * 0.1, 0.1);\n}");
            this.grainMesh = new c.Mesh(s,i),
            this.grainMesh.setPosition(0, 0, 1),
            this.grainMesh.setUniform("uTime", 0, "1f"),
            this.volume.add(this.grainMesh)
        }
        lerp(t, e, s) {
            return (1 - s) * t + s * e
        }
    ...
    class tt extends s {
        ...
        onResize(t) {
            super.onResize(t),
            this.enterThreshold = -this.viewport.height
        }
        onUpdate(t) {
            this.isActive && this.animations.forEach((e=>{
                e.onUpdate && e.onUpdate(t)
    ...
    new class {
        constructor() {
            ...
            this.enhanced = window.enhancedExperience,
            this.enhanced) {
                ...
                e.length && Promise.all(e).then((()=>{
                    ...
                    this.onUpdate(0),
                    this._handlePageAnchor(),
                    this._initializeTextFocus()
                }
                ))
            }
        }
        ...
        _initializeTextFocus() {
            ...
            document.querySelectorAll("[data-focus]").forEach((t=>{
                t.addEventListener("focusin", (e=>{
                    this.pressed || (window.scrollTo(0, t.dataset.focusOffset),
                    t.blur())
                }
                ))
            }
        ...
        _initializeLazyLoad() {
            ...
            t.forEach((t=>{
                this.lazyLoadItems.push({
                    section: t,
                    scrollTarget: t.offsetTop - t.offsetHeight,
                    lazyTarget: t.querySelector("picture[data-lazy]"),
                    lazyData: t.querySelector("noscript"),
                    loaded: !1
                })
            }
            ))
            ...
            this.lazyLoadItems.forEach((t=>{
                if (!t.loaded && (window.scrollY >= t.scrollTarget || window.pageYOffset >= t.scrollTarget)) {
                    if (t.lazyTarget && t.lazyData) {
                        ...
                        s.setAttribute("data-lazy", ""),
                        t.lazyTarget.parentNode.replaceChild(s, t.lazyTarget)
                    }
                    t.loaded = !0
                }
            }
        ...
        tick() {
            this.ticking || (this.frame = window.requestAnimationFrame(this.onUpdate.bind(this))),
            this.ticking = !0
        }
        debounceResize() {
        ...
        onScroll() {
            ...
            this.needsScrollUpdate = this.scrollMetrics.x !== t.x || this.scrollMetrics.y !== t.y,
        ...
        onResize() {
            ...
            (this.viewport.width !== e.width || this.viewport.height !== e.height) && (this.viewport = e,
            this.sections.forEach((t=>{
        ...
        onUpdate(t) {
            this.ticking = !1,
            this.needsScrollUpdate && this.sections.forEach((t=>{
            ...
            this.hasPersistentAnimation(),
            this.persistentAnimation ? (this.sections.forEach((e=>{
